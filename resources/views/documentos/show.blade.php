...
<body>
  <div style="position:relative;width:893px;height:1240px;">
    ...
    <p style="position:absolute;top:210px;left:125px;white-space:nowrap">
       ATO Nº {{ $documento['nu_documento'] }} / {{ $documento['nu_documento_privado'] }}, GESTÃO {{ $documento['gestao'] }}<br>FORTALEZA, {{ date('d/m/Y - H:m', strtotime($documento['dt_hr_publicacao'] )) }} - E.·.V.·.
    </p>
